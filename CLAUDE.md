...
| 重构日志 | [reconstruction-log.md](reconstruction-log.md) | 工程重构记录与验证清单 |
...
# 生成 .xcodeproj
cd PasteEcho && xcodegen generate

# 项目构建
xcodebuild -project PasteEcho.xcodeproj -scheme PasteEcho build

# 项目运行
xcodebuild -project PasteEcho.xcodeproj -scheme PasteEcho -configuration Debug run
```
